...
== Installing with MariaDB on Windows
  ...
  gem install mysql2-0.2.6.gem -- --with-mysql-include=C:/mariadb-5.1.50-win32/include --with-mysql-lib=C:/mariadb-5.1.50-win32/lib/opt

== Installing with MariaDB on Linux

  gem install mysql2-0.2.6.gem -- --with-mysql-include=/usr/include/mysql --with-mysql-lib=/usr/lib
