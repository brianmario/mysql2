...
Vio*  mysql_socket_vio_new(struct st_mysql_socket mysql_socket, enum enum_vio_type type, uint flags);
#ifdef __WIN__
...
struct st_vio
{
  struct st_mysql_socket  mysql_socket;           /* Instrumented socket */
